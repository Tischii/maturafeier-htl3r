...
if(isset($_GET['login'])) {
 ...
 header('Location: anmeldung.php');
	 ...
	 if ($passwort != null && password_verify($passwort, $user['passwort']) == false){
         $errorMessage = "Passwort ist ungültig<br> if 2";
     }
     elseif($benutzer != null) {
         $errorMessage = "Benutzer ist ungültig<br> if 1";
     }
     
     elseif ($passwort == null || $benutzer == null){
         $errorMessage = "Felder müssen ausgefüllt werden<br> if 3";
     }
 }
}
?>
...
<html>
  ...
  <body>
    ...
    <div class="text">
      ...
      <h2 class="textt">Melde dich hier an!<br> Die Anmeldedaten findest du auf deiner Einladung!</h2>
